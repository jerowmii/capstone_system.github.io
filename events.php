        ...
        <form method="post" id="forms">
            <div class="modal-content" >
                ...
                <div class="modal-footer">
                    <input type="hidden" name="category" id="category" value="Events & Announcements" />
...
<script>
    ...
    $(function () {   
        ...
        $('#add_button').click(function(){
            $('#forms')[0].reset();
            $('.modal-title').html("<i class='fa fa-plus-circle'></i> Create Events & Ann.s");
        ...
        $(document).on('click', '.update', function(){
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    ...
                    $('.modal-title').html("<i class='fa fa-edit'></i> Update Events & Ann.s");
                    $('#id').val(id);
