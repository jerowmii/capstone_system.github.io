...
$query .= "SELECT * FROM $CONTENT_TABLE WHERE category = 'SK Information' AND ";
...
function get_total_all_records($connect, $CONTENT_TABLE)
{
	...
	$statement = $connect->prepare("SELECT * FROM $CONTENT_TABLE WHERE category = 'SK Information' $query ");
	$statement->execute();
