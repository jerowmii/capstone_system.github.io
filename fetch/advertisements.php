...
$query .= "SELECT * FROM $CONTENT_TABLE WHERE category = 'Advertisements' AND ";
...
function get_total_all_records($connect, $CONTENT_TABLE)
{
	...
	$statement = $connect->prepare("SELECT * FROM $CONTENT_TABLE WHERE category = 'Advertisements' $query ");
	$statement->execute();
